...
public class SettingsEvents : MonoBehaviour
{
    ...
    private DropdownField dropdownQuality;      // Componente dropdown del documento UXML per scegliere la qualit� del gioco
    ...
    private void Awake()
    {
        ...
        InitDisplayResolution();    // Metodo che inizializza il men� a tendina della risoluzione
        InitQualitySettings();      // Metodo che inizializza il men� a tendina della qualit�
    ...
    /// <summary>
    /// Metodo che inizializza il men� a tendina della risoluzione dello schermo
    /// </summary>
    private void InitDisplayResolution()
    {
        // Prende le possibilit� di risoluzione dalle impostazioni di Unity e le inscerisce nel men� a tendina
    ...
    /// <summary>
    /// Metodo che inizializza il men� a tendina della qualit� del gioco
    /// </summary>
    private void InitQualitySettings()
    {
        // Prende le possibilit� di qualit� dalle impostazioni di Unity e le inserisce nel men� a tendina
